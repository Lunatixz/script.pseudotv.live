...
except: #todo:maybe failover for these just in case
    pass
...
class Artdownloader:
    ...
    def log(self, msg, level = xbmc.LOGNOTICE):
        logGlob('Artdownloader: ' + msg, level)
    
    def logDebug(self, msg):
        logGlob('Artdownloader: ' + msg)
    
    def logError(self, msg):
        logGlob('Artdownloader: ' + msg, xbmc.LOGERROR)
    ...
    def FindBug(self, chtype, chname, mediapath):
        ...
        #if REAL_SETTINGS.getSetting("SmallChannelBug"):
        #    DefaultBug = os.path.join(IMAGES_LOC,'PTVL_SMALL.png')
    ...
    def DownloadMetaArt(self, type, fle, id, typeEXT, ART_LOC):
        ...
        try:
            ...
            self.logError("artwork failed to derive path")
        return setImage
