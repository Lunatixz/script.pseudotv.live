...
from resources.lib.Globals import ascii, uni, logGlob
...
class Playlist:
    ...
    def log(self, msg, level = xbmc.LOGNOTICE):
        logGlob('Playlist: ' + msg, level)
    
    def logDebug(self, msg):
        logGlob('Playlist: ' + msg)
    
    def logError(self, msg):
        logGlob('Playlist: ' + msg, xbmc.LOGERROR)
    ...
    def load(self, filename):
        ...
        try:
            ...
            self.logError("ERROR loading playlist: " + filename)
        ...
        for i in range(len(lines)):
            ...
            try:
                ...
                self.logError("ERROR: Invalid line in playlist - " + filename)
                self.logError(traceback.format_exc())
    ...
    def save(self, filename):
        ...
        try:
            ...
            self.logError("save Unable to open the smart playlist")
            return
