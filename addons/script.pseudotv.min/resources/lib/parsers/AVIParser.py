...
from resources.lib.Globals import ascii, logGlob
...
class AVIParser:
    ...
    def log(self, msg, level = xbmc.LOGNOTICE):
        logGlob('AVIParser: ' + msg, level)
    
    def logDebug(self, msg):
        logGlob('AVIParser: ' + msg)
    
    def logError(self, msg):
        logGlob('AVIParser: ' + msg, xbmc.LOGERROR)
    ...
    def determineLength(self, filename):
        ...
        self.File.close()
        if dur == 0:
            self.logError('Duration: ' + str(dur))
        else:
